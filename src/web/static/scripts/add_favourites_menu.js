...
window.addEventListener('load', function()
{
	...
	if(test)
	{
		...
		if (favourites_!= null) 
		{
			for(let i=0; i<favourites_.length; i++)
			{
				...
				class_button_link.setAttribute('href', 'favourites.php#'+favourites_[i]);
		...
		all_button_link.setAttribute('href', 'classes.php');
	...
	else
	{
		...
		favourites_button_link.setAttribute('href', 'favourites.php');
