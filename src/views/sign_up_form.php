		...
		<main>
			<article class="general_content_box">
					...
					<form action="/sign_up.php" method="post">
						<table>
							<tr>
								...
								<td>
									<input type="text" name="email" id="email" required> <?php if(!($email==='ok')):?> Należy podać adres email <?php endif ?>
								</td>								
							</tr>
							<tr>
								<td>
								...
								<td>
									<input type="text" name="login" id="login" required> <?php if($login==='empty'):?> Należy podać login <?php endif ?> <?php if($login==='taken'):?> Login jest zajęty <?php endif ?>
								</td>									
							</tr>
							<tr>
								<td>
								...
								<td>
									<input type="password" name="haslo" id="password" required> <?php if($password==='empty'):?> Należy podać hasło <?php endif ?>
								</td>									
							</tr>
							<tr>
								<td>
								...
								<td>
									<input type="password" name="haslo2" id="password2" required> <?php if($password==='empty'):?> Należy podać hasło <?php endif ?> <?php if($password==='different'):?> Hasła muszą być identyczne<?php endif ?>
								</td>									
							</tr>
							<tr>
								<th>
				...
				<figure class="sub_container">
					<img src="static/img/welcome.jpg" alt="Obrazek z deską za napisem Welcome" title="Welcome">
				</figure>
			</article>
		</main>
		<?php
